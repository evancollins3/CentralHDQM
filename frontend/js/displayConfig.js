...
const displayConfig = (function() {
    const displayGroups = [
		...
		{
			name: "Mean_of_Bx_Wheels",
			plot_title: "Mean_of_Bx_Wheels",
			y_title: "BX distribution",
			subsystem: "RPC",
			correlation: false,
			series: ["BX_w0", "BX_wp1", "BX_wp2", "BX_wm1", "BX_wm2"],
		},
		{
			name: "Mean_of_Bx_pDisks",
			plot_title: "Mean_of_Bx_pDisks",
			y_title: "BX distribution",
			subsystem: "RPC",
			correlation: false,
		...
		{
			name: "N_SL_With_Residuals_Outside_Range",
			plot_title: "N_SL_With_Residuals_Outside_Range",
			y_title: "Number of segments with |residual mean| > 100 um",
			subsystem: "DT",
			correlation: false,
			series: ["MeanRes_Outside_0p01", "SigmaRes_Outside_0p05"],
		},
		{
			name: "Mean_Of_Residuals",
			plot_title: "Mean_Of_Residuals",
			y_title: "Mean of residuals distributions for phi superlayers",
			subsystem: "DT",
			correlation: false,
		...
		},
		{
			...
			plot_title: "Sigma_Of_Residuals",
			y_title: "Sigma of residuals distributions for phi superlayers",
			subsystem: "DT",
			correlation: false,
		...
		},
		{
			...
			plot_title: "Mean_Of_T0_in_MB1",
			y_title: "Mean of t0 distribution for MB1s",
			subsystem: "DT",
			correlation: false,
		...
		{
			name: "Mean_Of_T0_MB2",
			plot_title: "Mean_Of_T0_MB2",
			y_title: "Mean of t0 distribution for MB2s",
			subsystem: "DT",
			correlation: false,
		...
		{
			name: "Mean_Of_T0_MB3",
			plot_title: "Mean_Of_T0_MB3",
			y_title: "Mean of t0 distribution for MB3s",
			subsystem: "DT",
			correlation: false,
		...
		{
			name: "Mean_Of_T0_MB4",
			plot_title: "Mean_Of_T0_MB4",
			y_title: "Mean of t0 distribution for MB4s",
			subsystem: "DT",
			correlation: false,
			series: ["MeanT0_MB4_YB-2", "MeanT0_MB4_YB-1", "MeanT0_MB4_YB0", "MeanT0_MB4_YB1", "MeanT0_MB4_YB2"],
		},
		{
			name: "t0_correlation_plot_MB1_MB4",
			plot_title: "t0_correlation_plot_MB1_MB4",
			y_title: "Mean of t0 distribution for MB1s",
			subsystem: "DT",
			correlation: true,
			series: ["MeanT0_MB1_YB0", "MeanT0_MB4_YB0"],
		},
		{
			name: "Resolution",
